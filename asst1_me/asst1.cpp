...
static float g_scaleX = 1.0;      // scale factor for the width of the square
static float g_scaleY = 1.0;      // scale factor for the height of the square
...
static void reshape(int w, int h) {
  ...
  //fix ratio
  if (g_width * g_scaleX * h - g_height * g_scaleY * w < 0)
  {
    g_scaleX = g_width * g_scaleX * h / (g_height * g_scaleY * w);
    g_scaleY = 1.0;
  }
  else
  {
    g_scaleY = g_height * g_scaleY * w / (g_width * g_scaleX * h);
    g_scaleX = 1.0;
  }
