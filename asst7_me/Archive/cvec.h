...
inline Cvec3 interpolateCatmullRom(const Cvec3& c0, const Cvec3& c1, const Cvec3& c2, const Cvec3& c3, const double alpha) {

  Cvec3 d = (c2 - c0)*(1.0/6.0)  + c1;
  Cvec3 e = (c3 - c1)*(-1.0/6.0) + c2;
